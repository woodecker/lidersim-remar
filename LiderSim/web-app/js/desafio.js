...
window.onload = function() {
    ...
    $('#composto').change(function() {
        ...
        if ($('#composto').val() != '') {
            ...
            var url = location.origin + '/lidersim/composto/getTipoComposto/' + composto;
            ...
            var url = location.origin + '/lidersim/composto/getNomeComposto/' + composto;
            var data = {_method: 'GET'};
            ...
            var url = location.origin + '/lidersim/composto/getFormulaComposto/' + composto;
            var data = {_method: 'GET'};
